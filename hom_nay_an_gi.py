...
def render_navbar():
    # Title
    st.markdown('<h1 class="navbar-title">🍜 HÔM NAY ĂN GÌ?</h1>', unsafe_allow_html=True)
...
def render_home():
    ...
    <div class="hero">
        ...
        <div class="hero-subtitle2">Web hỗ trợ sinh viên lựa chọn quán ăn quanh khu vực Chùa Láng</div>
